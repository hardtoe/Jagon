...
// hardtoe: 1.8 degrees per step, 200 steps for 360 degrees, * 16x microstepping = 3200 steps per rotation

// X, Y, Z, E steps per unit - Metric Prusa Mendel with Greg's Accessible extruder (E was 700):
//float axis_steps_per_unit[] = {80, 80, 3200/1.25,423.2258064516129032258064516129}; 
float axis_steps_per_unit[] = {62.745, 80, 3200/1.25, 600}; 
