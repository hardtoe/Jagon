...
void TimerThree::setPwmDuty(char pin, int duty) // expects duty cycle to be 10 bit (4096)  (50%=2048, 100%=4096)
{
...
void TimerThree::pwm(char pin, int duty, long microseconds)  // expects duty cycle to be 10 bit (4096)  (50%=2048, 100%=4096)
{
